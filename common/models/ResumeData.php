...
class ResumeData extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['email', 'email'],
            [['contact_info', 'location_info', 'social_media_info', 'education_info', 'skills_info', 'experience_info', 'template', 'created_at', 'updated_at'], 'safe'],
            [['first_name', 'middle_name', 'last_name','template'], 'string', 'max' => 255],
